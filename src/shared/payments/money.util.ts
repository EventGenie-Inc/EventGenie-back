...
export const decimalToCents = (amount: Prisma.Decimal | number | string): number => {
...
export const applyBasisPoints = (amountCents: number, basisPoints: number): number =>
...
export const grossUpForFeeRate = (amountToPreserveCents: number, feePpm: number): number =>
  Math.round((amountToPreserveCents * 1_000_000) / (1_000_000 - feePpm));
