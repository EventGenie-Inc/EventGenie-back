...
export const assertMemoryHubAccessible = async (event: EntitlementDerivableEvent): Promise<void> => {
...
// ─────────────────────────────────────────
export const assertMemoryHubQuotaAvailable = async (event: EntitlementDerivableEvent & { id: string }): Promise<void> => {
