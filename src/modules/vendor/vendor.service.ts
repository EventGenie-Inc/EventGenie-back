...
export const vendorService = {
  ...
  // ─────────────────────────────────────────
  findNearbyVendors: async (latitude: number, longitude: number, requestingTenantId: string | null, radiusKm?: number) => {
  ...
  //  all.
  // ─────────────────────────────────────────
  getBrowseVendors: async (requestingTenantId: string | null) => {
    await assertVendorMarketplaceAccessible(requestingTenantId);
  ...
  // ─────────────────────────────────────────
  getNearbyVendorsForEvent: async (
    eventId: string,
  ...
  updateSpace: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null, data: UpdateVendorSpaceDto) => {
  ...
  archiveSpace: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
  ...
  reactivateSpace: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
  ...
  getMySpaces: (userId: string) => vendorRepository.findSpacesForUser(userId),
  ...
  getAllServices: async (vendorSpaceId: string, requestingRole: PlatformRole, tenantId: string | null, includeArchived = false) => {
  ...
  getServiceById: async (id: string, requestingRole: PlatformRole, tenantId: string | null, includeArchived = false) => {
    const service = await vendorRepository.findServiceById(id, includeArchived);
    if (!service) throw new HttpError(404, 'Vendor service not found');
  ...
  createService: async (vendorSpaceId: string, userId: string, requestingRole: PlatformRole, tenantId: string | null, data: CreateVendorServiceDto) => {
  ...
  updateService: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null, data: UpdateVendorServiceDto) => {
    await vendorService.getServiceById(id, requestingRole, tenantId);
    return vendorRepository.updateService(id, userId, data);
  },

  archiveService: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
    await vendorService.getServiceById(id, requestingRole, tenantId);
    return vendorRepository.archiveService(id, userId);
  },

  reactivateService: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
  ...
  getAllProducts: async (vendorServiceId: string, requestingRole: PlatformRole, tenantId: string | null, includeArchived = false) => {
  ...
  getProductById: async (id: string, requestingRole: PlatformRole, tenantId: string | null, includeArchived = false) => {
  ...
  createProduct: async (vendorServiceId: string, userId: string, requestingRole: PlatformRole, tenantId: string | null, data: CreateProductDto) => {
    await vendorService.getServiceById(vendorServiceId, requestingRole, tenantId);
    return vendorRepository.createProduct(vendorServiceId, userId, data);
  },

  updateProduct: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null, data: UpdateProductDto) => {
    await vendorService.getProductById(id, requestingRole, tenantId);
    return vendorRepository.updateProduct(id, userId, data);
  },

  archiveProduct: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
    await vendorService.getProductById(id, requestingRole, tenantId);
    return vendorRepository.archiveProduct(id, userId);
  },

  reactivateProduct: async (id: string, userId: string, requestingRole: PlatformRole, tenantId: string | null) => {
