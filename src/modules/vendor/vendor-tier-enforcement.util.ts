...
export const assertVendorSpaceCreatable = async (tenantId: string | null): Promise<void> => {
  if (!tenantId) return;
...
export const assertVendorMarketplaceAccessible = async (tenantId: string | null): Promise<void> => {
  if (!tenantId) return;
...
export const assertEventVendorMarketplaceAccessible = async (event: EntitlementDerivableEvent): Promise<void> => {
