...
export const isWithinGraceOrPaidPeriod = (tenant, now = new Date()) => resolveEffectiveTier(tenant, now) !== 'SPARK';
...
export const withEffectiveTier = (tenant) => ({
    ...tenant,
    subscriptionTier: resolveEffectiveTier(tenant),
});
//# sourceMappingURL=effective-tier.util.js.map