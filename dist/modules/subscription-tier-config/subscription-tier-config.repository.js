...
export const subscriptionTierConfigRepository = {
    findAll: () => prisma.subscriptionTierConfig.findMany({
        orderBy: { tier: 'asc' },
    }),
    findByTier: (tier) => prisma.subscriptionTierConfig.findUnique({
        where: { tier },
    }),
    create: (data) => prisma.subscriptionTierConfig.create({
        data: {
            tier: data.tier,
            ...
            maxMemoryHubBytesPerEvent: data.maxMemoryHubBytesPerEvent ?? null,
    ...
    update: (tier, data) => prisma.subscriptionTierConfig.update({
        ...
        data: {
            ...
            ...(data.maxMemoryHubBytesPerEvent !== undefined && { maxMemoryHubBytesPerEvent: data.maxMemoryHubBytesPerEvent ?? null }),
