...
import { isEventPassActive } from '../event-pass/event-entitlement.util.js';
...
// write was refused."
export const resolveGuestLimit = async (event) => {
...
export const assertGuestsCreatable = async (event, additionalCount) => {
    ...
    if (projected > resolved.limit) {
        ...
        throw new HttpError(403, `${source} This event currently has ${existingCount} guest(s), and this would add ${additionalCount} more ` +
