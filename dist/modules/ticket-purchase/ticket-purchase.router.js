...
router.get('/event/:eventId', async (req, res, next) => {
    try {
        const auth = req;
        await eventService.getById(req.params['eventId'], auth.user.role, auth.user.tenantId);
        const purchases = await ticketPurchaseService.getAllForEvent(req.params['eventId']);
