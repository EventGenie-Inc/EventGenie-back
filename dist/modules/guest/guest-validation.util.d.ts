...
export declare const assertExactlyOneContact: (email: string | null, phoneNumber: string | null, hostGuestId?: string | null) => void;
export declare const assertValidPlusOnesAllowed: (value: number) => void;
