...
// requireEventAdmin.
export const signMemoryItemUpload = (tenantId, eventId, mediaType) => {
    ...
    const signature = signCloudinaryParams({ allowed_formats: allowedFormats, folder, public_id: publicId, timestamp }, apiSecret);
    return {
        signature,
        timestamp,
        apiKey,
...
export const uploadService = {
    ...
    requestOrganiserMemoryItemSignature: async (requestingRole, requestingTenantId, data) => {
        if (!data.eventId) {
