...
export const smsSendLogRepository = {
    ...
    create: (tenantId, eventId, inviteId, source) => prisma.smsSendLog.create({ data: { tenantId, eventId, inviteId, source } }),
    ...
    countForTenantThisMonth: (tenantId) => {
        const now = new Date();
    ...
    countBundleUsedForEvent: (eventId) => prisma.smsSendLog.count({ where: { eventId, source: 'BUNDLE' } }),
};
//# sourceMappingURL=sms-send-log.repository.js.map